...
- Head terms ("mundial en vivo", "assistir copa ao vivo") against Globo/Telefe/Caracol — they have aged, authoritative domains. Don't burn effort fighting for these now.
...
- "[país] vs [país] transmisión en vivo gratis" (answer: the official free broadcaster)
...
- **First 100 words**: the answer — date, local kickoff time, the OFFICIAL channel/app, free-vs-pay.
- **Body (900+ words)**: where to watch per country (official broadcasters, linked), kickoff in multiple time zones, how to watch free legally, team form, FAQ.
...
- **assistircopaaovivo.live** — Portuguese per-match pages, lead every "free" answer with CazéTV's official YouTube.
...
Every watch/ver/assistir CTA → official broadcaster (CazéTV YouTube, Globo/Globoplay, Telefe, TyC Sports Play, Caracol, Win Sports, DGO, ESPN/Disney+). No embeds, no m3u8, no unlicensed stream links. Pages that link to legal sources stay indexed through the whole tournament; pages that link to pirate streams get pulled mid-event and you lose everything at peak traffic. Legal = durable = ranked.
